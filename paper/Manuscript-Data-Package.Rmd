...
The objective of this paper is to describe the {canaccesR} Open Data Product (ODP), an open data package.
...
By integrating and processing raw data from diverse sources, estimating TTM's for two destinations types (e.g., jobs and groceries) across Canada's largest cities of the country, and making these findings publicly available, we hope this ODP can advance the field of urban analytics in Canada.
